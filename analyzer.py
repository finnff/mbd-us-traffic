...
class ColumnAnalyzer:
    ...
    def _update_counters(self, chunk: pd.DataFrame):
        ...
        for col in self.columns:
            ...
            missing_mask = chunk[col].isna() | (chunk[col] == '') | (chunk[col].astype(str).str.strip() == '')
    ...
    def _generate_report(self) -> Dict:
        ...
        for col in self.columns:
            ...
            report[col] = {
                ...
                'top_values': top_values_with_pct
            }
...
def save_report_as_csv(report: Dict, output_file: str):
    ...
    print(f"2. frequencies_{output_file} - Top {len(report[list(report.keys())[0]]['top_values'])} values for each column")
